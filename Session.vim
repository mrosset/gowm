...
map <silent> <F3> :set guioptions+=m
map <silent> <F2> :set guioptions-=m
imap 	 
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
set mouse=a
set ruler
set sessionoptions=blank,buffers,curdir,folds,help,options,tabpages,winsize,buffers,help,options,winsize
set shiftwidth=4
set showmatch
set smarttab
set softtabstop=4
...
set shortmess=aoO
badd +26 gowm.go
badd +8 ~/src/dwm/config.h
badd +1 ~/src/x-go-binding/xgb/xproto.go
badd +1 Makefile
badd +294 ~/src/x-go-binding/xgb/xgb.go
badd +3 test
badd +1 cannot\ connect:\ cannot\ connect\ to\ 
badd +1 tinywm.c
args gowm.go
edit gowm.go
...
44
normal! 04l
tabedit ~/src/x-go-binding/xgb/xproto.go
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
